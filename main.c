/*
The main file, contains the code to run the main infinite loop for the shell. 
It also displays the finished background processes by checking for signals that indicate 
whether the child is dead or not. 
*/
